    ...
    <div className="min-h-screen bg-background transition-all duration-300">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-4xl mx-auto text-left bg-card/50 p-6 rounded-lg shadow-sm">
          <h2 className="text-xl font-semibold mb-4 text-primary">Welcome to Domain Name Outbounding Templates</h2>
          <div className="space-y-4 text-muted-foreground">
            <p>
              Welcome to Domain Name Outbounding Templates, the ultimate resource for professionals and enthusiasts looking to excel in the domain name marketplace! Our mission is to simplify the process of reaching out to potential buyers, ensuring your domain sales efforts are efficient, professional, and successful.
            </p>
            <p>
            ...
            <p className="font-medium text-foreground">
              - Sam, Founder of Domain Name Outbounding Templates
            </p>
          </div>
        </div>
